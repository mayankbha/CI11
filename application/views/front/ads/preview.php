...
<button class="btn" type="button" onClick="window.location='<?php  echo site_url('ads/configured/'.$ad['ads_id']); ?>'">Back</button>&nbsp;

<button class="btn" type="buttom" onClick="window.location='<?php  echo site_url('ads/index/'.$ad['ads_id']); ?>'">Edit</button>&nbsp;
...
<div class="span6">
	<div class="span7" style="overflow: hidden; border: 2px solid black; width:482px;" id="cont_div">
	  <!--ad content -->
